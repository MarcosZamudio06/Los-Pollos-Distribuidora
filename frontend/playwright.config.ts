  ...
  webServer: [
    {
      ...
      env: {
        ...
        OBJECT_STORAGE_BUCKET: env.objectStorageBucket,
        OBJECT_STORAGE_REGION: "us-east-1",
        OBJECT_STORAGE_ENDPOINT: env.objectStorageEndpoint,
        OBJECT_STORAGE_PUBLIC_ENDPOINT: env.objectStoragePublicEndpoint,
        OBJECT_STORAGE_ACCESS_KEY_ID: env.objectStorageAccessKeyId,
        OBJECT_STORAGE_SECRET_ACCESS_KEY: env.objectStorageSecretAccessKey,
