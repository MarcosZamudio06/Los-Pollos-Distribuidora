...
const close: DailyClose = {
  ...
  initialCashOut: '0',
  version: 5,
  operationalLocation: { id: 'location-1', name: 'Sucursal Centro', code: 'CENTRO' },
  totalInputKg: '30',
  totalSoldKg: '20',
  totalRemainingKg: '10',
  totalShortageKg: '1',
  ...
  sales: [{ saleNumber: 'V-100', documentType: 'SIMPLE_NOTE', requiresAdministrativeInvoice: true, total: '13200', billingRequests: [{ id: 'billing-1', status: 'REQUESTED', requestedAt: '2026-07-22T12:00:00.000Z' }] }],
  differences: [],
}

function render(step: 'operations' | 'signoff') {
  return renderToStaticMarkup(<DailyCloseGuidedFlow activeStep={step} canAuthorizeDifferences canClose canEditDifferences canEditInventory canViewFinancials canViewInventory canViewProfit close={close} inventoryReconciliation={null} onAuthorizeDifference={vi.fn()} onDeleteInventoryCount={vi.fn()} onJustifyDifference={vi.fn()} onRequestClose={vi.fn()} onSaveInventoryCount={vi.fn()} onStepChange={vi.fn()} products={[]} validationResult={null} />)
}
