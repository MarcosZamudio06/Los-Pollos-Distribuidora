...
const close: DailyClose = {
  id: 'close-1', operationalLocationId: 'location-1', businessDate: '2026-07-22', status: 'DRAFT', cashSessionStatus: 'OPEN', terminalIdentifier: 'Caja 01', openedAt: '2026-07-22T08:03:00.000Z', initialCashFund: '1500', initialCashIn: '0', initialCashOut: '0', version: 2,
