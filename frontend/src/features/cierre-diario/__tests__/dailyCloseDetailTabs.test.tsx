...
const close: DailyClose = {
  ...
  purchaseCostTotal: "8000",
  grossProfitTotal: "5200",
  netProfitTotal: "5120",
  costQuality: "EXACT",
  ...
  payments: [
    {
      ...
      status: "APPLIED",
      referenceNumber: "SPEI-123",
      paidAt: "2026-07-22T12:05:00.000Z",
    },
    {
      id: "payment-2",
      saleId: "sale-1",
      ...
      paymentMethod: "CASH",
      status: "APPLIED",
      referenceNumber: "CAJA-100",
      paidAt: "2026-07-22T12:06:00.000Z",
    },
  ],
  cashMovements: [
    {
  ...
  inventoryMovements: [
    {
      ...
      product: { id: "product-1", name: "Pollo entero", sku: "POL-001" },
    },
  ],
  lines: [
    {
  ...
  excludedOperations: [
    {
      ...
      occurredAt: "2026-07-22T13:30:00.000Z",
    },
  ],
};
  ...
  it("opens the transfer total with only transfer and deposit payments", async () => {
    ...
    try {
      ...
      const transferButton = Array.from(
        ...
        button.textContent?.includes("Transferencias y depósitos"),
      );
