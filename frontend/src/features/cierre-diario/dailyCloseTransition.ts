...
export function getDailyCloseTransitionCopy(action: DailyCloseReportAction) {
  return action === "close"
    ? {
        ...
        description:
          "El reporte quedará cerrado con los totales actuales y dejará de actualizarse automáticamente.",
    ...
    : {
        ...
        description:
          "El reporte volverá a borrador y podrá resincronizar ventas, pagos, gastos y movimientos.",
