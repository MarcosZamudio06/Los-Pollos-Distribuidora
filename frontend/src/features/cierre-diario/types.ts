...
export type DailyCloseDifferenceScope =
  "CASH" | "SCALE" | "INVENTORY" | "SALES" | "EXPENSES" | "BILLING";
export type DailyCloseDifferenceUnit = "MXN" | "KG" | "PIECE";
export type DailyCloseDifferenceType = "SURPLUS" | "SHORTAGE";
export type DailyCloseDifferenceStatus =
  "PENDING_JUSTIFICATION" | "PENDING_AUTHORIZATION" | "AUTHORIZED";
...
export function canUseLocationForDailyClose(type: string) {
  return (
    type === "BRANCH" || type === "MIXED" || type === "EXTERNAL_POINT_OF_SALE"
  );
}
...
export type DailyCloseCashShift = {
  id: string;
  terminalId: string;
...
export type DailyClose = {
  ...
  totalShortageKg: string;
  totalSurplusKg: string;
  scaleReportedKg: string;
  scaleDifferenceKg: string;
  cashTotal: string;
  ...
  cashShifts?: Array<DailyCloseCashShift>;
};
...
export type DailyCloseInventoryReconciliation = {
  ...
  items: Array<{
    ...
    openingQuantityKg: Quantity;
    openingQuantityPieces: number;
    entriesQuantityKg: Quantity;
    entriesQuantityPieces: number;
    soldQuantityKg: Quantity;
    soldQuantityPieces: number;
    otherOutputsQuantityKg: Quantity;
    otherOutputsQuantityPieces: number;
    theoreticalQuantityKg: Quantity;
    theoreticalQuantityPieces: number;
    physicalQuantityKg: Quantity | null;
    physicalQuantityPieces: number | null;
    surplusQuantityKg: Quantity;
    surplusQuantityPieces: number;
    shortageQuantityKg: Quantity;
    shortageQuantityPieces: number;
    count?: {
      id: string;
      reason: string;
