...
export function billingRequestStatusLabel(status: BillingRequestStatus) {
  return labels[status];
}

export function billingRequestStatusTone(
...
export function availableBillingRequestActions(
  status: BillingRequestStatus,
  role?: string | null,
