...
type CartTableProps = Pick<CartPanelProps, 'activeItemId' | 'highlightedItemId' | 'items' | 'onActivate' | 'onQuantityChange' | 'onQuantityCommit' | 'onQuantityFocus' | 'onRemove'>

function CartTable({ activeItemId, highlightedItemId, items, onActivate, onQuantityChange, onQuantityCommit, onQuantityFocus, onRemove }: CartTableProps) {
  return (
...
export const CartPanel = memo(function CartPanel({ activeItemId, highlightedItemId, items, onActivate, onQuantityChange, onQuantityCommit, onQuantityFocus, onRemove }: CartPanelProps) {
  return (
