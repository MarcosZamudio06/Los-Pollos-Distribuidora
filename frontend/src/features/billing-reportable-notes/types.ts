...
export type BillingReportItem = {
  ...
  activeInvoiced: string;
  pendingInvoice: string;
  pendingSubtotal: string;
  pendingTax: string;
  pendingTotal: string;
  requestableItems: ReadonlyArray<{
    saleItemId: string;
    productName: string;
    pendingSubtotal: string;
    pendingTax: string;
...
export type BillingInvoiceRecord = Record<string, string | null> & {
  id: string;
  status: string;
  reversedAt?: string | null;
};
export type BillingReportDetail = BillingReportItem & {
  ...
  activeInvoices: BillingInvoiceRecord[];
  invoiceHistory: BillingInvoiceRecord[];
